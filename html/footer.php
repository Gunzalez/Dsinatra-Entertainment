    	...
    	<div class="content-box">
            ...
            <ul class="quicklinks">
               ...
               <!-- <li><a href="events.php"><span>Dsinatra Events Calendar</span>
                ...
                <li><a href="events.php"<?php echo isActive($currPage, $pagesArr[3], $classStr) ?>>Events</a></li>  
                <li><a href="/blog/"<?php echo isActive($currPage, $pagesArr[2], $classStr) ?>>Blog</a></li>  
                <li><a href="about.php"<?php echo isActive($currPage, $pagesArr[5], $classStr) ?>>About</a></li> -->   
            </ul>
        </div> 
