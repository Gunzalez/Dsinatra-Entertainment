...
<!--                    <a href="wsn-form.php" class="big-yellow">Entry Form</a>-->
            ...
            <li>
                ...
                <div class="copy">
                    ...
                    <p class="clearfix"><span>World Super Model Nig</span></p>
                    <a href="gallery.php?queen=2" class="big-yellow">See photos</a>
                </div>
            </li>
            <li>
                ...
                <div class="copy">
                    <p class="clearfix"><span>When the queen met</span></p>
                    <p class="clearfix"><span>the governor</span></p>
