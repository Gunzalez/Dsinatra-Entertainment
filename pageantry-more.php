    	...
    	<div class="centered clearfix">
            ...
            <div class="content-box wide">
                ...
                <div class="copy">
                    ...
                    <p>“WSN” – World Supermodel Nigeria 2015/16” debuts in Delta State, for the second time, It’s an event poised to bringing out hidden talents, it will be a way of bringing the glitz, glamour, culture, creativity and a medium to network.</p>
                    ...
                    <p>WORLD SUPERMODEL NIGERIA is not targeted at Delta state alone, but also the external community and Nigeria at large. This will result in impressive media coverage which will epitomize the essence of WORLD SUPER MODEL NIGERIA.</p>
                    ...
                    <h2>The Programmed Component</h2>
                    <p>Highlights of the event include:</p>
                    <ul>
                        <li>Fashion show</li>
                        <li>Pageantry</li>
                        <li>Music Performances</li>
                        <li>Award and giving of prizes</li>
                    </ul>
