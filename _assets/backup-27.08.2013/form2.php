    ...
    <div class="content">
    	<div class="centered clearfix">
            ...
            <div class="content-box wide"> 
                ...
                <form name="application-form" id="application-form" action="apply2.php" method="post" enctype="multipart/form-data">
            ...
            <div class="content-box sidebar">
                ...
                <ul class="newslist">
                    ...
                    <li><a href="news/story1.php">Miss West Africa Nigeria conculded at the grande finale on the 23rd of February.</a></li>                                               
                </ul>            
            </div>
