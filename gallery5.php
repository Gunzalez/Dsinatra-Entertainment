    ...
    <div id="gallerypage" class="content">
    	<div class="centered clearfix">
            ...
            <div class="content-box wide"> 
                <h2 class="clearfix"><span>Miss West Africa International 2014</span></h2>
                <div id="photos" class="copy galleries">
                	<?php require_once('gallery/mwai-3.php'); ?>
                </div>
            </div>
            ...
            <div class="content-box sidebar" id="photo-nav">
                ...
                <ul class="newslist">
                    <li class="active"><a href="gallery/mwai-3.php" id="mwai-3">Airtel Welcome Party <br>The girls get going</a></li>
                	<li><a href="gallery/mwai-1.php" id="mwai-1">9th of December 2014 <br>Workout session</a></li>
                	<li><a href="gallery/mwai-2.php" id="mwai-2">Miss West Africa International <br>Breakfast time</a></li>
                	<li><a href="gallery/mwai-4.php" id="mwai-4">The grand finale of the Miss West Africa International event</a></li>
                </ul>
